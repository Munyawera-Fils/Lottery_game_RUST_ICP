...
import { idlFactory } from './project1.did.js';
export { idlFactory } from './project1.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PROJECT1_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./project1.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the project1 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./project1.did.js")._SERVICE>}
 */
export const project1 = createActor(canisterId);
